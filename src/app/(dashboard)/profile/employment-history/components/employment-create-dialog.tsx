...
import { useCreateEmploymentHistory } from "../hooks";
...
export function EmploymentCreateDialog({
  open,
  onOpenChange,
}: {
  open: boolean;
  ...
  const watchIsCurrent = methods.watch("isCurrentEmployment");
  ...
  const { mutateAsync } = useCreateEmploymentHistory({ ...getValues() });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {/* <Alert className="bg-blue-50 border-blue-200">
          ...
          <AlertDescription>
            Your employment details will be securely sent to our verification
