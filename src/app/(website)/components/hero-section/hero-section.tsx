        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              ...
              <span className="text-primary">property</span> easily
            </h1>
            <p className="mt-5 text-lg text-gray-800 dark:text-neutral-400">
              A great platform to buy, sell, or even rent your properties
              without any commisions.
            </p>
            {/* 
            <div className="grid grid-cols-2 gap-4">
              <blockquote className="p-4 my-4 border-s-2  border-violet-200">
                <h1 className="text-3xl text-gray-900 dark:text-white">50k+</h1>
                <p className="text-sm text-gray-900">renter</p>
              </blockquote>
              <blockquote className="p-4 my-4 border-s-2 border-violet-200">
                <h1 className="text-3xl text-gray-900 dark:text-white">10k+</h1>
                <p className="text-sm text-gray-900">properties</p>
              </blockquote>
            </div> */}

            <div className="mt-7 grid gap-3 w-full sm:inline-flex sm:mb-5">
              <Link
                className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-primary text-white hover:bg-primary/90 disabled:opacity-50 disabled:pointer-events-none"
                href={RENT_LISTING_PAGE_PATH}
              >
                Looking for Rent
                {/* <svg
          ...
          <div className="relative ms-4 max-md:hidden  max-sm:hidden">
            <Image
              className="w-full rounded-md "
              src="/assets/bg-hero-image.svg"
              alt="hero section map"
              width={100}
              height={100}
            />
          </div>
